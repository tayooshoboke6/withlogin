          ...
          <MenuItem active={location.pathname.startsWith('/admin/categories')}>
            <Link to="/admin/categories">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                ...
                <path d="M10 0v6h6V0h-6Zm5 1v4h-4V1h4ZM8 1V0h1v2H8v2H7V1h1Zm0 5V4h1v2H8ZM6 8V7h1V6h1v2h1V7h5v1h-4v1H7V8H6Zm0 0v1H2V8H1v1H0V7h3v1h3Zm10 1h-1V7h1v2Zm-1 0h-1v2h2v-1h-1V9Zm-4 0h2v1h-1v1h-1V9Zm2 3v-1h-1v1h-1v1h2v-1Zm-4 0v-1H8v1h2Zm-4 0v-1H3v2h1v-1h2Zm-3 0v-1H0v2h2v-1h1Z"/>
              </svg>
